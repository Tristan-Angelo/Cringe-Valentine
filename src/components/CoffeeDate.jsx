...
const fortunes = [
  ...
  "Slow down. The good stuff needs time to steep.",
  "A warm cup and a familiar face will find you today.",
  "Something small will make you smile—notice it.",
  "Best served today: kindness with extra foam.",
  "Your presence is the comfort drink of the day.",
  "Today’s flavor note: calm, sweet, and steady.",
  "Even the quiet moments are working in your favor.",
  "A shared cup beats any fancy recipe.",
  "Let today unfold one sip at a time.",
  "Comfort is closer than you think.",
  "The right words will come—no rush.",
  "Good things are brewing, just out of sight.",
  "This moment is already enough.",
  "Your warmth lingers longer than caffeine.",
  "Today calls for softness, not speed.",
  "Today’s cup is best enjoyed without overthinking.",
  "Warm hands, calm heart, steady day.",
  "Something familiar will feel especially nice today.",
  "Take the long sip—there’s no need to rush.",
  "A small pause will bring a big sense of ease.",
  "Your presence is already enough.",
  "This moment doesn’t need improvement.",
  "Today’s blend favors honesty and comfort.",
  "Let the quiet parts of the day speak.",
  "The simplest plans often turn out best.",
  "You’re exactly where you need to be right now.",
  "A gentle answer will go further than expected.",
  "Comfort has a way of finding you today.",
  "Trust the slow warmth—it lasts longer.",
  "Nothing important is being missed.",
  "Some things are better felt than figured out.",
  "Today rewards patience over speed.",
  "There’s ease in doing just one thing well.",
  "You don’t have to earn rest.",
  "The day will meet you halfway.",
];
